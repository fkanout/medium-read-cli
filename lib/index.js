...
const getMoreArticles = async () =>{
  log();
  spinner = ora(chalk.blueBright('Loading more articles... ' )).start();
  page ++;
...
const start = ()=>{ 
  clearScreen();
  topic = readlineSync.question('What do you feel like reading today ? ');
  readSomeStories(topic);
}

const footer = () => log('ESC to exit', 'SPACE to load more article');
